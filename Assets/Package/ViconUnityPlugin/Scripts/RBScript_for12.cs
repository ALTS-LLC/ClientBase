...
{
    public class RBScript_for12 : MonoBehaviour
    {
        [SerializeField]
        ...
        void Update()
        {
            ...
            if (ORot.Result == Result.Success && OTran.Result == Result.Success && !OTran.Occluded)
            {
                ...
                Quaternion Translate = new Quaternion((float)ORot.Rotation[0], (float)ORot.Rotation[1], (float)ORot.Rotation[2], -(float)ORot.Rotation[3]);
                List<Quaternion> _aaa = new List<Quaternion>();
                _aaa.Add(new Quaternion(Translate.x, Translate.y, Translate.z, -Translate.w));
                _aaa.Add(new Quaternion(Translate.x, Translate.z, Translate.y, Translate.w));//kore
                _aaa.Add(new Quaternion(Translate.y, Translate.x, Translate.z, Translate.w));
                _aaa.Add(new Quaternion(Translate.y, Translate.z, Translate.x, Translate.w));
                _aaa.Add(new Quaternion(Translate.z, Translate.x, Translate.y, Translate.w));
                _aaa.Add(new Quaternion(Translate.z, Translate.y, Translate.x, Translate.w));



                Root.localRotation = _aaa[_index];
